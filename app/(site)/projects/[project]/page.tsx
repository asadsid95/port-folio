        ...
        <div className="max-w-3xl mx-auto py-5 text-gray-400 h-[50vh] text-center ">
            ...
            {project.listOfTechnologies && (
                ...
                <div className="text-lg  text-gray-400 my-5">
                    <p className="underline font-bold">Technologies:<br /></p>
                    <div>
            ...
            {project.role && project && project.responsibilities && (
                ...
                <div className="flex justify-center gap-5">
                    <div className="flex flex-col">
                        <p className="underline font-bold">Role:<br /></p>
                    ...
                    <div className="flex flex-col">
                        ...
                        <p className="underline font-bold">Responsibilities:<br /></p>
            ...
            <div className="pb-5">
                <p className="underline font-bold">Lessons learned<br /></p>
